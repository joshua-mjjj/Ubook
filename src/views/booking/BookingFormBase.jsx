...
function BookingForm(props) {
  ...
  const [email, setEmail] = React.useState(localStorage.getItem("auto_fill_email"));
  const [name, setName] = React.useState(localStorage.getItem("auto_fill_name"));


  const [booking_type, setBooking_type] = React.useState(null);
  ...
  const make_booking = () => {
  	...
  	}else if(contact && booking_type !== null && location !== null && start_date && start_time && end_time && minutes){
...

         {
			 ...
			 <div>
	          <Alert severity="success"
	            ...
	            }>{"Your booking has successfully been created."}</Alert>
	         </div>
         	):null
	    }
