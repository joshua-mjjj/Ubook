         ...
         <Grid item xs={6}>
             <div style={{ display: 'flex', flexDirection: 'column' }}>
             	<FormLabel style={{ margin: "10px", fontSize: "14px" , fontWeight: '800'}} component="label" className={classes.formLabel}>
		            Please kindly share the following info. <br />
		            It helps us to reach out and provide more <br />
		             assistance 
               ...
               <div style={{ margin: "10px"  }}>
                 <div className="gpt3__cta-content_button_text">
                   <span style={{ fontSize: '15px', color: "blue", fontWeight: 'bold' }} >Default Costs</span>
                    <span style={{ fontSize: '15px', color: "blue" }} >DAILY: <span style={{ color: "red" }}>7:00 AM - 5:00 PM > Shs 50,000 per hr</span></span>
                    <span style={{ fontSize: '15px', color: "blue" }} >DAILY: <span style={{ color: "red" }}>5:00 PM - 11:30 PM > Shs 80,000 per hr</span></span>
                    <span style={{ fontSize: '15px', color: "blue" }} >WEEKENDS: <span style={{ color: "red" }}>Shs 80,000 per hr</span></span>
                 </div>
                </div>
	            <Input
		            fullWidth
