...
function ListTable(props) {
  ...
  React.useEffect(() => {
    if(props.bookings !== null){
      const list_bookings = props.bookings.filter((booking) => booking.blocked_off === false  && booking.cancelled === false && booking.block_booking === false);
  ...
  return (
    ...
    <div style={{ marginTop : "10px"}}>
      <p className={classes.sub_title} >Notifications</p>
    </div>
